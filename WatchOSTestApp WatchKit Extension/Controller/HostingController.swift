...
class HostingController : WKHostingController<LoginView>, CBPeripheralDelegate, CBCentralManagerDelegate {
    ...
    // Bluetooth
    let scannerCBUUID = CBUUID(string: "0x1811")
    ...
    func scanForPeripherals() {
        ...
        self.centralManager.scanForPeripherals(withServices: [CBUUID(string: "0x1812"), CBUUID(string: "0x1802"), CBUUID(string: "0x1825")])
//        self.centralManager.scanForPeripherals(withServices: nil)
    ...
    func centralManager(_ central: CBCentralManager, didDiscover peripheral: CBPeripheral, advertisementData: [String : Any], rssi RSSI: NSNumber) {
        print(peripheral)
//        if peripheral.name ?? "" == "KDC470[014550]" {
